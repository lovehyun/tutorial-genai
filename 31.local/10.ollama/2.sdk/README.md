...
| 파일 | 내용 | REST 짝 |
|---|---|---|
| `1.chat.py` | 기본 채팅 (`ollama.chat`) | `../1.restapi/1.chat.py` |
| `2.streaming.py` | 스트리밍 (`stream=True` for 루프) | `../1.restapi/2.streaming.py` |
| `3.multiturn.py` | 멀티 턴 (히스토리 누적) | `../1.restapi/3.multiturn.py` |
...
- 더 높은 추상화(체인·메모리·툴·RAG)는 [`../3.langchain`](../3.langchain).
