...
| 파일 | 내용 | SDK 짝 |
|---|---|---|
| `1.chat.py` | 기본 채팅 (POST /api/chat) | `../2.sdk/1.chat.py` |
| `2.streaming.py` | 스트리밍 (NDJSON 줄 파싱) | `../2.sdk/2.streaming.py` |
| `3.multiturn.py` | 멀티 턴 (히스토리 누적) | `../2.sdk/3.multiturn.py` |
