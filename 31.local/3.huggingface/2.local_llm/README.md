...
(이 레포 곳곳에서 쓰는 모델들 — `4.mistral`, `5.llama`, `10.ollama/5.qwen25`, `10.ollama/6.qwen35`, `10.ollama/7.exaone35`, `2.langchain/.../local_model` 참고)
...
| **Qwen 2.5 / Qwen 3.5** | Alibaba (중국) | 다국어(한국어 포함) 강함, 3.5는 생각모드 하이브리드 | Apache-2.0 | `10.ollama/5.qwen25`, `10.ollama/6.qwen35`, `2.langchain` |
...
| **EXAONE 3.5 / 4.0** | LG AI Research (한국) | 한국어 강함, 4.0부터 생각모드+tool calling 지원 | 비상업 · gated | `10.ollama/7.exaone35`, `10.ollama/8.exaone40` |
