# 10.moderation_content_safety — 콘텐츠 안전성 검사 (Moderation API)
...
## 실행
```bash
cd 1.openai/10.moderation_content_safety
...
- 더 정교한 안전/권한 제어는 에이전트 도구 제한([`2.langchain/8.agents` 또는 `5.mcp/4.langchain/4.tools_safety`])과 함께 쓰세요.
