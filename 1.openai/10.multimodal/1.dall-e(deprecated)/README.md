...
> 본격 활용은 `7.gpt_image_app/`에 있습니다.
> 현행 이미지 모델·가격은 [7.gpt_image_app/README.md](../7.gpt_image_app/README.md) 참고.
...
[`7.gpt_image_app/README.md`](../7.gpt_image_app/README.md)에 정리되어 있습니다.
