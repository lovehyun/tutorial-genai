# 12.finetuning — OpenAI 모델 파인튜닝 (Fine-tuning API)
...
| 목적 | 써야 할 것 |
|------|-----------|
| 최신/사내 **정보**를 알게 하기 | **RAG** (`8.rag`) — 파인튜닝 ❌ |
...
- `30.study/2.bert/` — BERT 분류 파인튜닝 (HuggingFace Trainer)
- `31.local/2.mymodel/`, `31.local/3.huggingface/` — 로컬 모델 학습
