# OpenAI REST API - 11단계: Responses API — 대화 이어가기 (previous_response_id)
#
# 10단계 대비 새로 추가된 것:
...
#
# (chat.completions 방식의 멀티턴은 ../2.sdk/4.chat_multiturn.py 와,
#  같은 일을 SDK로 더 간결하게 한 버전은 ../2.sdk/11.response_multiturn.py 와 비교해 보세요.)
#
# 저장 기간:
...
# (../2.sdk/4.chat_multiturn.py 참고). Responses는 그 일을 서버가 대신 한다.
