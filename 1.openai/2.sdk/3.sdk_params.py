# OpenAI SDK - 3단계: SDK에서 파라미터 적용
#
# 2단계 대비 추가: ../1.restapi/3.restapi_params.py(REST)에서 다룬 응답 제어 파라미터를 SDK 방식으로.
...
response = client.chat.completions.create(
    ...
    # --- 응답 제어 파라미터 (../1.restapi/3.restapi_params.py 와 동일, 전달 위치만 다름) ---
