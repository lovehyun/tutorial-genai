...
> 본격 활용은 `../5.gpt_image_app/`에 있습니다.
> 현행 이미지 모델·가격은 [5.gpt_image_app/README.md](../5.gpt_image_app/README.md) 참고.
...
[`5.gpt_image_app/README.md`](../5.gpt_image_app/README.md)에 정리되어 있습니다.
