# 4.tts — 음성 생성 기초 (Text-To-Speech)

**TTS = 텍스트를 입력으로 받아 음성을 생성하는 것** (텍스트 → 오디오).
반대 방향인 **음성 인식(STT, 오디오 → 텍스트)** 은 [`../3.stt/1.whisper_stt/`](../3.stt/1.whisper_stt/) 참고.
...
## 실행
```bash
cd 1.openai/9.multimodal/4.tts
...
## 참고
- 음성 인식(STT): [`../3.stt/1.whisper_stt/`](../3.stt/1.whisper_stt/) · 실시간 음성 앱: [`../5.realtime_voice/1.webrtc_app/`](../5.realtime_voice/1.webrtc_app/)
