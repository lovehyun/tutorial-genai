# 3a: 메모리 기반 대화 히스토리 (시간 측정 없는 기본형)
# app2a 대비 달라진 것: 매 요청을 conversation_history 리스트에 누적해서
# 다음 요청 때 함께 전송 → 챗봇이 이전 대화를 "기억"한다.
# 요청/응답 시간까지 재는 버전은 app3b_history_time.py 참고.
