...
| `10.multimodal/` | 멀티모달 | 비전·이미지 생성·음성(STT/TTS/실시간·오디오 chat) |
| `11.moderation/` | 안전성 검사 | Moderation API로 입력 안전성 가드 (무료) |
| `12.batch/` | 배치 처리 | 대량 작업 비동기·50% 비용 (임베딩/분류) |
| `13.finetuning/` | 파인튜닝 | 내 데이터로 학습 → `ft:` 모델 (스타일·형식 일관성) |
