...
|----------------|----------------|-----------|-----------|
| OpenAI | `tools` / `function_calling` | `functions` 배열 | `tool_calls` 메시지 |
...
4. **npm/pip**: `npm search mcp-server` 또는 `pip search mcp-server`
...
> **이전 강의:** [LangGraph 에이전트](10_langgraph_agents.md) | **다음 강의:** [HuggingFace 로컬 모델 활용](12_huggingface_local.md)
