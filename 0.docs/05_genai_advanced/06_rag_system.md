...
pip install langchain==0.3.14 \
            ...
            rank-bm25==0.2.2 \
            "sentence-transformers>=3.3,<5" \
            fastapi==0.115.6 \
            uvicorn==0.34.0
# 버전 핀은 2025-01 기준 예시입니다. 최신 호환 버전은 https://pypi.org 에서 확인하세요.
```
...
| `multilingual-e5-large` | intfloat (Microsoft Research) | 1024 | 매우 우수 | 무료 | 다국어 지원, 로컬 실행 |
| `ko-sroberta-multitask` | jhgan | 768 | 우수 | 무료 | 한국어 특화, 경량 |
