"""
LangChain 빌트인 도구 카탈로그 — 어떤 도구들이 이미 준비돼 있나?
이 예제: load_tools 로 즉시 가져올 수 있는 모든 도구 이름을 출력합니다.

직접 만들기 전에 "이미 누가 만들어둔 게 있나" 확인하는 습관을 들이세요.
이 폴더 (3.builtin_tools) 의 나머지 파일들은 이 중 자주 쓰는 것들을 본격 활용합니다.
...
#   - WikipediaQueryRun, ArxivQueryRun                          → 3.1, 3.2 에서 사용
#   - TavilySearch (langchain-tavily 패키지)                     → 3.3 에서 사용
