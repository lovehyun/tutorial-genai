...
| `3.5_multi_collection.py` | 여러 컬렉션 분리 + 통합 검색 |
| `3.6_mixed_sources.py` | txt 2개(한 컬렉션) + pdf 2개(각각 별도) → 컬렉션 = 독립 검색 공간 시연 |
| `3.7_faiss_compare.py` | FAISS 비교 — 왜 Chroma 가 학습 / 일반 실무 RAG 에 더 매끄러운지 체감 |
