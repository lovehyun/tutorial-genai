...
직접 짤 때보다 짧지만, 내부 동작이 가려져 있어 처음엔 4.1 의 직접 형 먼저 익히는 게 좋음.
  ...
  ※ LangChain 1.0 부터 이 빌트인 체인들은 `langchain-classic` 패키지로 분리됨(레거시).
    현행 표준은 4.1 의 LCEL 직접 구성. 이 예제는 "옛 빌트인은 이렇게 썼다" 참고용.
      pip install langchain-classic
    (구) from langchain.chains import ...  →  from langchain_classic.chains import ...
"""
