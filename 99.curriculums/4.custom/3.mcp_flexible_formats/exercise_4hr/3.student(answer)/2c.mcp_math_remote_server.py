...
바뀌는 코드는 mcp.run() 딱 한 줄뿐이고, 도구 정의는 완전히 동일하다.

DONE — 2.student(todo) 의 mcp.run() TODO 를 채운 정답.
