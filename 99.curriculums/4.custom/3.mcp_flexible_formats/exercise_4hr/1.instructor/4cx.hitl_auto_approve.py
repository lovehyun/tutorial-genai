...
18.mcp_ops_hitl/4.auto_approve 의 AUTO_APPROVED 집합 아이디어를 CLI로 단순화한 것.
...
# 인자(어떤 파일인지)와 무관하게 delete_file 호출이면 뭐든 통과된다 — 18.mcp_ops_hitl의
...
#   프로세스 밖에 상태를 두면 해결된다(18.mcp_ops_hitl가 ops.db 파일을 쓰는 이유이기도 하다).
