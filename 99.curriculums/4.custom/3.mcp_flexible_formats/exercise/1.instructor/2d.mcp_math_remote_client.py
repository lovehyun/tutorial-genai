...
# ─── 실행 결과 (2026-08-12, gpt-4o-mini, 서버 먼저 실행한 상태) ─
# 원격 서버에서 가져온 도구 4개: ['hello', 'add', 'word_count', 'now']
#
# [질문] 17 더하기 25는 얼마야? 그리고 '원격 MCP 서버에 붙었다' 가 몇 단어인지도 세줘.
#
#   → 원격 도구 호출: add({'a': 17, 'b': 25})
#   → 원격 도구 호출: word_count({'text': '원격 MCP 서버에 붙었다'})
#
# [답변] 17 더하기 25는 42입니다. 그리고 '원격 MCP 서버에 붙었다'는 4단어입니다.
