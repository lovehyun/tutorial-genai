...
| | | `8.mcp/1.basic/2.protocol_deep/2.simple_client.py` | [실습] MCP 클라이언트 연결 |
...
| | | `8.mcp/4.langchain/4.tools_safety/server.py` | [실습] 도구 안전성 서버 |
| | | `8.mcp/4.langchain/4.tools_safety/2.client2_restrict.py` | [실습] 도구 접근 제한 |
