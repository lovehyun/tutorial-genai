...
| | | `5.mcp/1.basic/2.protocol_deep/1.simple_server.py` | [실습] MCP 서버 구현 |
| | | `5.mcp/1.basic/2.protocol_deep/2.simple_client.py` | [실습] MCP 클라이언트 연결 |
| 14:45-15:30 | MCP 에이전트 연동 | `5.mcp/2.openai/1.agent_tool/server.py` | [실습] 에이전트용 MCP 서버 |
| | | `5.mcp/2.openai/1.agent_tool/3.client_gpt.py` | [실습] GPT 기반 MCP 에이전트 |
| | | `5.mcp/4.langchain/3.langchain_bridge/mcp_bridge.py` | [실습] MCP → LangChain 브릿지 |
...
| | | `5.mcp/4.langchain/4.tools_safety/server.py` | [실습] 도구 안전성 서버 |
| | | `5.mcp/4.langchain/4.tools_safety/2.client2_restrict.py` | [실습] 도구 접근 제한 |
...
| 확장 Day | 내용 | 추가 자료 |
|----------|------|-----------|
| Day 6 | MCP 심화 — 멀티 도구 서버, LangGraph 브릿지, Claude Desktop 연동 | `5.mcp/2.openai/2.multi_tools/`, `5.mcp/3.anthropic/1.claude_desktop/` |
