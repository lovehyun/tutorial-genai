...
| 09:30-10:00 | MCP 서버/클라이언트 복습 | `8.mcp/1.basic/2.protocol_deep/1.simple_server.py`, `8.mcp/1.basic/2.protocol_deep/2.simple_client.py` | MCP 기본 구조 재확인 |
...
| 13:00-13:30 | 도구 안전성 | `8.mcp/4.langchain/4.tools_safety/server.py`, `8.mcp/4.langchain/4.tools_safety/2.client2_restrict.py` | 도구 접근 제한 설계 |
