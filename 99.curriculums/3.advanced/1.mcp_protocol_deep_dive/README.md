...
| 09:30-10:00 | 에이전트 도구 서버 | `8.mcp/2.openai/1.agent_tool/server.py`, `8.mcp/2.openai/1.agent_tool/server2.py` | 에이전트용 도구를 제공하는 MCP 서버 |
| 10:00-10:30 | 에이전트 클라이언트 (데모) | `8.mcp/2.openai/1.agent_tool/1.client_demo.py`, `8.mcp/2.openai/1.agent_tool/2.client_simple_nlp.py` | 에이전트 클라이언트 기본 |
...
| 09:30-10:00 | 파일시스템 서버 | `8.mcp/9.projects/1.local/1.filesystem/server/server.py`, `8.mcp/9.projects/1.local/1.filesystem/server/server2.py` | 파일 시스템 접근 MCP 서버 |
| 10:00-10:30 | 파일시스템 클라이언트 | `8.mcp/9.projects/1.local/1.filesystem/client/client.py`, `8.mcp/9.projects/1.local/1.filesystem/client/client2.py` | 파일 시스템 MCP 클라이언트 |
| 10:45-11:15 | 파일시스템 MCP 클라이언트 | `8.mcp/9.projects/1.local/2.filesystem_client/1.fs_mcp_client.py`, `8.mcp/9.projects/1.local/2.filesystem_client/2.fs_mcp_client2_config.py` | 설정 기반 MCP 클라이언트 |
| 11:15-12:00 | GPT 연동 파일시스템 | `8.mcp/9.projects/1.local/2.filesystem_client/3.fs_mcp_client3_gpt.py` | GPT + MCP 파일시스템 에이전트 |
| 13:00-13:30 | 리모트 MCP 서버 | `8.mcp/9.projects/2.remote/1.intro/server/server.py` | 원격 MCP 서버 구성 |
| 13:30-14:00 | 리모트 MCP 클라이언트 | `8.mcp/9.projects/2.remote/1.intro/client/client.py` | 원격 MCP 클라이언트 연결 |
| 14:00-14:30 | Claude Desktop Hello | `8.mcp/3.anthropic/1.claude_desktop/1.mcp_hello/hello_server.py` | Claude Desktop에 MCP 서버 등록 |
| 14:45-15:15 | Claude Desktop 네트워크 | `8.mcp/3.anthropic/1.claude_desktop/2.simple_net_local/simple_net_check.py`, `8.mcp/3.anthropic/1.claude_desktop/3.simple_net_remote/simple_net_server.py` | 로컬/리모트 네트워크 MCP |
| 15:15-15:45 | 파일 컨버터 서버 | `8.mcp/3.anthropic/1.claude_desktop/4.file_converter/file_converter_server.py`, `8.mcp/3.anthropic/1.claude_desktop/4.file_converter/file_converter2_server_errhandler.py` | 파일 변환 MCP 서버 |
| 15:45-16:15 | 파일 컨버터 테스트 | `8.mcp/3.anthropic/1.claude_desktop/4.file_converter/test_fileconverter_client.py` | MCP 서버 테스트 작성 |
