...
| 10:45-11:15 | Ollama 기초 (REST vs SDK) | `3.local/6.ollama1_restapi/1.chat.py`, `3.local/6.ollama2_sdk/1.chat.py` | 같은 호출을 REST API vs 파이썬 SDK 로 비교 |
| 11:15-12:00 | Ollama 스트리밍 | `3.local/6.ollama1_restapi/2.streaming.py`, `3.local/6.ollama2_sdk/2.streaming.py` | 스트리밍 응답 (REST 파싱 vs SDK for 루프) |
...
| 15:15-15:45 | 한국어 NLP (감성분석/분류) | `3.local/8.ollama_qwen/1.chat.py`, `3.local/8.ollama_qwen/2.sentiment.py`, `3.local/8.ollama_qwen/3.classification.py` | 한국어 챗, 감성분석, 텍스트 분류 |
| 15:45-16:15 | 한국어 NLP (NER/요약/번역) | `3.local/8.ollama_qwen/4.ner.py`, `3.local/8.ollama_qwen/5.summarization.py`, `3.local/8.ollama_qwen/6.translation.py` | 개체명 인식, 요약, 번역 |
...
- `3.local/6.ollama1_restapi/` · `6.ollama2_sdk/` · `6.ollama3_langchain/` — Ollama (REST → SDK → LangChain)
- `3.local/7.gpt4all/` — GPT4All
- `3.local/8.ollama_qwen/` — 한국어 NLP
