...
| 09:30-10:00 | GPT-2 로컬 실행 | `31.local/1.transformers/3.2_decoder_generate.py` | HuggingFace에서 GPT-2 로드 및 텍스트 생성 |
| 10:00-10:30 | LangChain 연동 & Flask 서빙 | `31.local/1.transformers/6.1_langchain_integration.py`, `31.local/1.transformers/6.2_flask_serving.py` | 로컬 모델을 LangChain/Flask로 서빙 |
| 10:45-11:15 | Ollama 기초 (REST vs SDK) | `31.local/10.ollama/1.restapi/1.chat.py`, `31.local/10.ollama/2.sdk/1.chat.py` | 같은 호출을 REST API vs 파이썬 SDK 로 비교 |
| 11:15-12:00 | Ollama 스트리밍 | `31.local/10.ollama/1.restapi/2.streaming.py`, `31.local/10.ollama/2.sdk/2.streaming.py` | 스트리밍 응답 (REST 파싱 vs SDK for 루프) |
| 13:00-13:30 | GPT4All 기초 | `31.local/6.gpt4all/1.intro.py`, `31.local/6.gpt4all/2.basic_qa.py` | GPT4All 설치와 기본 QA |
