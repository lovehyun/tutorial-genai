...
| 10:45-11:15 | Ollama 기초 (REST vs SDK) | `3.local/6.ollama/1.restapi/1.chat.py`, `3.local/6.ollama/2.sdk/1.chat.py` | 같은 호출을 REST API vs 파이썬 SDK 로 비교 |
| 11:15-12:00 | Ollama 스트리밍 | `3.local/6.ollama/1.restapi/2.streaming.py`, `3.local/6.ollama/2.sdk/2.streaming.py` | 스트리밍 응답 (REST 파싱 vs SDK for 루프) |
...
| 14:45-15:15 | HuggingFace 파이프라인 | `3.local/3.huggingface/1.pipelines/1.1_cla_sentiment.py`, `3.local/3.huggingface/1.pipelines/1.5_ext_qa.py` | 감성분석, QA 파이프라인 |
| 15:15-15:45 | 한국어 NLP (감성분석/분류) | `3.local/6.ollama/5.qwen/1.chat.py`, `3.local/6.ollama/5.qwen/2.sentiment.py`, `3.local/6.ollama/5.qwen/3.classification.py` | 한국어 챗, 감성분석, 텍스트 분류 |
| 15:45-16:15 | 한국어 NLP (NER/요약/번역) | `3.local/6.ollama/5.qwen/4.ner.py`, `3.local/6.ollama/5.qwen/5.summarization.py`, `3.local/6.ollama/5.qwen/6.translation.py` | 개체명 인식, 요약, 번역 |
...
- `3.local/6.ollama/1.restapi/` · `6.ollama/2.sdk/` · `6.ollama/3.langchain/` — Ollama (REST → SDK → LangChain)
- `3.local/7.gpt4all/` — GPT4All
- `3.local/6.ollama/5.qwen/` — 한국어 NLP
