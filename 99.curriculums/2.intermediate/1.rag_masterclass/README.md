...
| 09:30-10:00 | 토큰화 시각화 | `30.study/6.embedding/1.tokenize_visualize.py` | 텍스트가 토큰으로 변환되는 과정 시각화 |
| 10:00-10:30 | 임베딩 시각화 | `30.study/6.embedding/2.embedding_visualize.py` | 임베딩 벡터의 의미 공간 시각화 |
| 10:45-11:15 | 벡터 공간 (2D/3D) | `30.study/6.embedding/3.vector_space_2d.py`, `30.study/6.embedding/5.vector_space_3d.py` | 2D, 3D 벡터 공간에서 유사도 이해 |
| 11:15-12:00 | 유사도 행렬 | `30.study/6.embedding/4.similarity_matrix.py` | 코사인 유사도 행렬 계산 및 시각화 |
| 13:00-13:45 | FAISS 기초 | `1.openai/8.rag/1.rag_basic.py`, `1.openai/8.rag/2.rag_similarity_score.py` | FAISS 인덱스 생성, 검색 기초 |
| 13:45-14:30 | FAISS 로컬 임베딩 | `1.openai/8.rag/3.rag_local_embedding.py`, `1.openai/8.rag/4.rag_cosine_similarity.py` | 로컬 임베딩 모델 + 코사인 유사도 |
| 14:45-15:30 | FAISS 모델 비교 | `1.openai/8.rag/5.rag_better_embedding_model.py` | 다양한 임베딩 모델 성능 비교 |
...
## 참고 자료
- `30.study/6.embedding/` — 임베딩 이론 및 시각화
- `1.openai/8.rag/` — FAISS 기초
