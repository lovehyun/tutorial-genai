...
| 09:30-10:00 | 기본 그래프 | `2.langchain/9.langgraph/1.basic_graph.py` | StateGraph 생성, 노드/엣지 정의 |
| 10:00-10:30 | 메모리 & 체크포인팅 | `2.langchain/9.langgraph/2.memory_checkpointing.py` | 상태 저장 및 복원 메커니즘 |
| 10:45-11:15 | 조건부 분기 | `2.langchain/9.langgraph/3.conditional_branching.py` | 조건에 따른 동적 라우팅 |
| 11:15-12:00 | 도구 순환 그래프 | `2.langchain/9.langgraph/4.tools_cyclic_graph.py` | 도구 호출 → 결과 분석 → 재호출 순환 |
| 13:00-13:30 | 상태 디버깅 | `2.langchain/9.langgraph/5.state_debugging.py` | 그래프 상태 추적 및 디버깅 기법 |
| 13:30-14:00 | Self-Correction 루프 | `2.langchain/9.langgraph/6.self_correction_loop.py` | 출력 검증 → 자동 수정 반복 패턴 |
| 14:00-14:30 | AgentOps 모니터링 | `2.langchain/9.langgraph/7.agentops_monitoring.py` | 에이전트 실행 모니터링 |
| 14:45-15:30 | 커스텀 도구 + LangGraph | `2.langchain/9.langgraph/10.customtools1_addmultiply_langgraph.py` | 기존 커스텀 도구를 LangGraph로 전환 |
...
## 참고 자료
- `2.langchain/9.langgraph/` — LangGraph 예제 전체
